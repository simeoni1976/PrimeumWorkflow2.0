...
namespace Workflow.BusinessCore.DataLayer.Migrations
{
    ...
    [Migration("20171211170132_AddSelectorInstanceUser")]
    partial class AddSelectorInstanceUser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.Action", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ActionParameter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.Property<long>("ReferenceSequence");
                    ...
                    b.ToTable("ActionParameter");
                });

            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ActionSequence", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ConfigVariable", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("ConfigVariable");
                });

            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.Constraint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ConstraintParameter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.ToTable("ConstraintParameter");
                });

            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ConstraintSequence", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.Criteria", b =>
                {
                    ...
                    b.Property<long?>("SelectorConfigModifyDataId");
                    ...
                    b.HasIndex("SelectorConfigModifyDataId");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.DistinctValue", b =>
                {
                    ...
                    b.Property<string>("NumericalFormat");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.SelectorConfig", b =>
                {
                    ...
                    b.Property<long>("ActionSequenceRef");

                    b.Property<DateTime>("AddedDate");

                    b.Property<long>("ConstraintSequenceRef");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.SelectorInstance", b =>
                {
                    ...
                    b.Property<int>("ChainNumberModifyer");

                    b.Property<DateTime>("ModifiedDate");

                    b.Property<long>("ModifyerId");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.SelectorInstanceUser", b =>
                {
                    b.Property<long>("SelectorInstanceId");
                    ...
                    b.HasKey("SelectorInstanceId", "UserId");

                    b.HasAlternateKey("Id");

                    b.HasIndex("UserId");

                    b.ToTable("SelectorInstanceUser");
                });
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ValueObject", b =>
                {
                    ...
                    b.Property<double?>("VolatileValue");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.WorkflowConfig", b =>
                {
                    ...
                    b.Property<long?>("IdWorkflowConfigOriginal");
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ActionSequence", b =>
                {
                    b.HasOne("Workflow.BusinessCore.DataLayer.Entities.Action", "Action")
                        .WithMany()
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.ConstraintSequence", b =>
                {
                    b.HasOne("Workflow.BusinessCore.DataLayer.Entities.Constraint", "Constraint")
                        .WithMany()
            ...
            modelBuilder.Entity("Workflow.BusinessCore.DataLayer.Entities.Criteria", b =>
                {
                    ...
                    b.HasOne("Workflow.BusinessCore.DataLayer.Entities.SelectorConfig", "SelectorConfigModifyData")
                        .WithMany("ModifyCriterias")
                        .HasForeignKey("SelectorConfigModifyDataId");
